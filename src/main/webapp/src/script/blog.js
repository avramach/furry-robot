...
function createBlog() {
    var blogTemplate = '<h2><b><span id="blog-1-title"></span></b></h2> \
                        <div class="panel panel-default"> \
                            <div class="panel-body"> \
                                <span id="blog-1-content"></span> \
                            </div> \
                            <div class="panel-footer row"> \
                                <div class="col-md-6"> \
                                    <a href="#">#delete</a> \
                                ...
                                <div class="col-md-2"> \
                                    <a href="#">Comments <span class="badge" id="blog-1-comments"></span></a> \
                                </div> \
                                <div class="col-md-2"> \
                                    <a href="#"><span class="glyphicon glyphicon-thumbs-up"></span> <span class="badge" id="blog-1-upvotes"></span></a> \
                                </div> \
                                <div class="col-md-2"> \
                                    <a href="#"><span class="glyphicon glyphicon-thumbs-down"></span> <span class="badge" id="blog-1-downvotes"></span></a> \
                                </div> \
                            </div> \
                        </div>'
